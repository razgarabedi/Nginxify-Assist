  ...
  return (
    <div className="space-y-10 md:space-y-12">
      <section className="text-center px-4">
        <h1 className="text-3xl md:text-4xl font-bold tracking-tight mb-4">{language === 'en' ? 'How It Works' : 'So Funktioniert\'s'}</h1>
      ...
      <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
        <InfoCard
          ...
          title={language === 'en' ? 'Volunteer Commitment' : 'Ehrenamtliches Engagement'}
        ...
        <InfoCard
          ...
          title={language === 'en' ? 'Free & Donation-Based' : 'Kostenlos & Spendenbasiert'}
          description={language === 'en'
        ...
        />
         <InfoCard
          ...
          title={language === 'en' ? 'Requesting Help' : 'Hilfe Anfordern'}
          description={
            language === 'en' ? (
              <>
              ...
              <>
                ...
                <Link href="/contact" className="text-primary hover:underline font-medium">Kontaktformular</Link>
        ...
        <InfoCard
          ...
          title={language === 'en' ? 'Expectation Management' : 'Erwartungsmanagement'}
          description={language === 'en'
        ...
        />
         <InfoCard
          ...
          title={language === 'en' ? 'Who We Are' : 'Wer wir sind'}
          description={language === 'en'
        ...
        />
         <InfoCard
          ...
          title={language === 'en' ? 'Use of Donations (Optional)' : 'Spendenverwendung (Optional)'}
          description={language === 'en'
       ...
       <section className="text-center py-10 bg-secondary rounded-lg shadow-md mt-10 md:mt-12 px-4">
         <h2 className="text-xl md:text-2xl font-semibold mb-4">{language === 'en' ? 'Ready to Request Help?' : 'Bereit, Hilfe anzufragen?'}</h2>
         ...
         <Button asChild size="lg" variant="default" className="bg-primary hover:bg-primary/90"> {/* Use primary color */}
           <Link href="/contact">{language === 'en' ? 'Contact Us Now' : 'Jetzt Kontakt aufnehmen'}</Link>
         </Button>
       </section>
    </div>
  );
