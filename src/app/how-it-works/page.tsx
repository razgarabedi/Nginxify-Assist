  ...
  return (
    <div className="space-y-12">
      <section className="text-center">
        <h1 className="text-4xl font-bold tracking-tight mb-4">{language === 'en' ? 'How It Works' : 'So Funktioniert\'s'}</h1>
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
       ...
       <section className="text-center py-10 bg-secondary rounded-lg shadow-md mt-12">
         <h2 className="text-2xl font-semibold mb-4">{language === 'en' ? 'Ready to Request Help?' : 'Bereit, Hilfe anzufragen?'}</h2>
